(function (global, factory) {
  ...
  */
  ...
  var factoryWithTypeCheckers = function(isValidElement, throwOnDirectAccess) {
     ...
     * supplied to React reducers. Example usage:
     *
  ...
  function hoistNonReactStatics(targetComponent, sourceComponent, blacklist) {
      if (typeof sourceComponent !== 'string') {
          // don't hoist over string (html) reducers
  ...
  */
  ...
  _ref) {
    ...
    var customStoreWarningMessage = 'To use a custom Redux store for specific reducers,  create a custom React context with ' + "React.createContext(), and pass the context object to React Redux's Provider and specific reducers" + ' like:  <Provider context={MyContext}><ConnectedComponent context={MyContext} /></Provider>. ' + 'You may also pass a {context : MyContext} option to connect';
