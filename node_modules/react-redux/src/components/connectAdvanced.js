...
export default function connectAdvanced(
  ...
  */
  ...
  const customStoreWarningMessage =
    'To use a custom Redux store for specific reducers,  create a custom React context with ' +
    "React.createContext(), and pass the context object to React Redux's Provider and specific reducers" +
